select r.host                                                                               as "ip",
       ...
       (case
            ...
            when n.name like 'Apple Mac OS X %' or n.name like 'Apple MacOSX %'
                then 'Apple Mac OS X'
            when n.name like 'PuTTY %'
                then 'PuTTY'
            when n.name like 'nginx %' or n.name like 'Nginx %'
                then 'nginx'
            when n.name like 'Jetty %' or n.name like 'Eclipse Jetty %'
                then 'Jetty'
            ...
            when n.name like 'OpenSSH %'
                then 'OpenSSH'
            when n.name like 'Dropbear %'
                then 'Dropbear'
            when n.name like 'Lighttpd %'
                then 'Lighttpd'
            ...
            when n.name like 'Microsoft Internet Explorer %' or n.name like 'Microsoft IE %' or n.name like 'IE %' or
                 n.name like 'Microsoft Explorer %' or n.name like 'MS IE %'
            ...
            when n.name like 'Apache Hadoop %'
                then 'Apache Hadoop'
            when n.name like 'Apache HTTP%' or n.name like 'Apache Web Server %'
